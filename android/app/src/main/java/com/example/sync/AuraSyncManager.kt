...
import com.example.api.AuraApiClient
import com.example.api.SyncChangeDto
import com.example.api.SyncPushRequest
        ...
        try {
            ...
            if (response.isSuccessful && response.body()?.success == true) {
                ...
                for (planDto in data.plans) {
                    ...
                    val localPlan = com.example.data.DailyPlan(
